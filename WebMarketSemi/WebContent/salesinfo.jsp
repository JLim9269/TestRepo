...
<body>
<%    
    String sql="select * from sale s,delivery d,product p where s.productId=p.p_id and s.sessionId=d.sessionId order by s.seq";
...
<div class="container col-11 alert alert-info" >
  ...
  <div>
    <table class="table table-hover">
       ...
       <%
  		sql="select * from sale s,delivery d,product p where s.productId=p.p_id and s.sessionId=d.sessionId order by s.seq";
