...
<div class="container">
	...
	<form class="form-horizontal" method="post" name="newProduct" action="./processAddProduct.jsp" enctype="multipart/form-data">
		<div class="form-group row">
			<label class="col-sm-2"><fmt:message key="productId"/></label>
			<div class="col-sm-3">
				<input class="form-control"type="text"name="productId"id="productId"value="<%=pid%>"readonly>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<select class="form-control"name="category"id="category">
					<%
						sql = "select distinct categoryName from category order by seq";
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input class="form-control"type="text"name="unitsInStock"id="unitsInStock">
			</div>
		</div>
		<div class="form-group row">
